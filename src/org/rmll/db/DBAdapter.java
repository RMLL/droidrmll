...
import org.rmll.pojo.Day;
import org.rmll.pojo.Event;
import org.rmll.pojo.Person;
import org.rmll.pojo.Room;
...
public class DBAdapter extends ContentProvider {
	...
	// Provider related
	public static final String PROVIDER_NAME = "org.rmll.pojo.Event";
	...
	// DB Related
	protected static final String DB_NAME = "rmll_schedule";
