...
public class DisplayEvent extends Activity {
	...
	public final static String ACTION_DISPLAY_EVENT = "org.rmll.schedules.DISPLAY_EVENT";

	/** Id extras parameter name */
	public final static String ID = "org.rmll.Id";
	...
	private void showEvent(Event event) {
		...
		setTextViewText(R.id.event_room, getString(R.string.event_room, event.getRoom()));
